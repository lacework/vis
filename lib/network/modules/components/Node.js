...
import CircularOverImageBase from './nodes/shapes/CircularOverImageBase'
    ...
    if (this.options.image !== undefined) {
      if (this.imagelist) {
        ...
        if(this.options.circularImage !== undefined) {
          this.circularImageObj = this.imagelist.load(this.options.circularImage, 
            this.options.brokenImage, this.id);
        }
      }
      else {
    ...
    if (currentShape === this.options.shape && this.shape) {
      ...
      switch (this.options.shape) {
        ...
        case 'circularOverImage':
          this.shape = new CircularOverImageBase(this.options, this.body, this.labelModule,
            this.imageObj, this.circularImageObj);
          break;
        case 'database':
